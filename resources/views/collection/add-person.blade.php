			...
			<div class="col-md-8 col-md-offset-1">
			  	...
			  	<div class="form-group" ng-class="{'has-error': vm.frmCreate.lname.$invalid && vm.frmCreate.withError }">
			        ...
			        <div class="col-md-9 col-sm-9 col-xs-12 form-group">
			          <input type="text" name="lname" class="form-control col-md-7 col-xs-12 text-uppercase" ng-model="vm.categoryDetails.lname" required>
			  	...
			  	<div class="form-group" ng-class="{'has-error': vm.frmCreate.fname.$invalid && vm.frmCreate.withError }">
			        ...
			        <div class="col-md-9 col-sm-9 col-xs-12 form-group">
			          <input type="text" name="fname" class="form-control col-md-7 col-xs-12 text-uppercase" ng-model="vm.categoryDetails.fname" required>
			  	...
			  	<div class="form-group" ng-class="{'has-error': vm.frmCreate.mname.$invalid && vm.frmCreate.withError }">
			        ...
			        <div class="col-md-9 col-sm-9 col-xs-12 form-group">
			          <input type="text" name="mname" class="form-control col-md-7 col-xs-12 text-uppercase" ng-model="vm.categoryDetails.mname">
			          <span class="help-block" ng-show="vm.frmCreate.mname.$invalid && vm.frmCreate.withError">Middlename is required field.</span>
			        </div>
			  	</div>
